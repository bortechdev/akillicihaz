        ...
        while(!sifreDogruFormatta(sifre)) {
        	...
        	while(!kullaniciGecerli(kullanici)) {
                ...
                while(!idDogruFormatta(id)) {
                    ...
                    id = scanner.nextLine();
                    if(!idDogruFormatta(id)) System.out.println("Id dogru formatta degil, bos olamaz");
                }
                kullanici = kullaniciRepository.getKullanici(id);
                if(!kullaniciGecerli(kullanici)) System.out.println("Kullanici gecerli degil, boyle bir kullanici yok");
        	}
        	while(!sifreDogru(kullanici, sifre)) {
                System.out.println("Sifrenizi giriniz");
                sifre = scanner.nextLine();
            	if(!sifreDogruFormatta(sifre)) System.out.println("Sifre dogru formatta degil, bos olamaz");
            	if(!sifreDogru(kullanici, sifre)) System.out.println("Sifre yanlis");
            }
